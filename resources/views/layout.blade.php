...
<body>
    ...
    {{-- footer --}}
    {{-- Button CTC --}}
    <div tabindex="-1" class="fixed bottom-0 right-0 z-50 m-5 bg-[#25D366] rounded-full p-4">
        <a href="https://wa.me/6281555633367"><svg class="fill-slate-100" style="height: 40px" role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
