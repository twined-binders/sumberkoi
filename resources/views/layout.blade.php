                ...
                <div class="flex gap-60">
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="https://laravel.com/" class="hover:underline hover:text-[#FF2D20]">Laravel</a>
                            </li>
                            <li>
                                <a href="https://tailwindcss.com/" class="hover:underline hover:text-[#06B6D4]">Tailwind CSS</a>
                            </li>
                        </ul>
                    </div>
                    <div>
                        ...
                        <ul class="text-gray-500 dark:text-gray-400 font-medium">
                            <li class="mb-4">
                                <a href="https://www.facebook.com/pusatkoiblitar/" class="hover:underline hover:text-[#1877F2]">Facebook</a>
                            </li>
                            <li class="mb-4">
                                <a href="https://www.instagram.com/sumberkoiblitar/" class="hover:underline hover:text-[#E4405F]">Instagram</a>
                            </li>
                            <li>
                                <a href="https://wa.me/6281555633367" class="hover:underline hover:text-[#25D366]">Whatsapp</a>
                            </li>
                        </ul>
                    </div>
                    <div>
